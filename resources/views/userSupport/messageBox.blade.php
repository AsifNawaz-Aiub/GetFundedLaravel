...
<div style="margin-left:15%">
  <div class="w3-container">
    <div class="container">
      ...
      <input class="btn-sm btn-dark" type="button" name="click" id="AppEvents" value="Open Chat...">
      ...
      <table class="table table-hover" id="events">
        ...
        @for($i=0; $i < count($message); $i++)
          <tr id="rows">
            ...
            <td>{{$message[$i]['messageText']}}</td>
            <td>
              <a class="btn btn-dark" href="/userSupport/deleteMessage/{{$message[$i]['id']}}">Delete</a>
            </td>
          </tr>
      ...
      <br>
      <input class="btn btn-info" type="submit" name="submit" value="Send..." style="float:right; ">
      </form>
  </div>
</div>
</div>
